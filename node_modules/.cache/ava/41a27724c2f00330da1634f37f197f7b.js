...
test('like imagenes', (() => {
  var _ref4 = _asyncToGenerator(function* (t) {
    ...
    let imagen = fixtures.getImage();
    let created = yield db.guardarImagen(imagen);
    let result = yield db.likeImagen(created.public_id);
...
test('obtener imagen', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    let imagen = fixtures.getImage();
    let created = yield db.guardarImagen(imagen);
    let result = yield db.getImagen(created.public_id);
...
test('obtener usuario', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-db/test/db-test.js', 110), _avaThrowsHelperEnd(t, db.getUsuario('equivoca'))), /no encontrado/);
  });
...
test('autenticar usuario', (() => {
  var _ref9 = _asyncToGenerator(function* (t) {
    ...
    let fallido = yield db.autenticar(usuario.username, 'foo');
    ...
    let falla = yield db.autenticar('foo', 'bar');
...
//# sourceMappingURL=..\node_modules\.cache\ava\41a27724c2f00330da1634f37f197f7b.js.map