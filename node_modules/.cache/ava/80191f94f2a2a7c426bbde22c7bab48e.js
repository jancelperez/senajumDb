...
test('obtener imagen', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-db/test/db-test.js', 69), _avaThrowsHelperEnd(t, db.getImagen('foo'))), /not found/);
  });
...
test('obtener usuario', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-db/test/db-test.js', 110), _avaThrowsHelperEnd(t, db.getUsuario('foo'))), /not found/);
  });
...
//# sourceMappingURL=..\node_modules\.cache\ava\80191f94f2a2a7c426bbde22c7bab48e.js.map