...
test('obtener imagen', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-db/test/db-test.js', 69), _avaThrowsHelperEnd(t, db.getImagen('foo'))), / no hay fuente /);
  });
...
test('autenticar usuario', (() => {
  var _ref9 = _asyncToGenerator(function* (t) {
    ...
    let fail = yield db.autenticar(usuario.username, 'foo');
    ...
    let failure = yield db.autenticar('foo', 'bar');
...
//# sourceMappingURL=..\node_modules\.cache\ava\2d00da69ecd1720ed15c5e81762a752b.js.map