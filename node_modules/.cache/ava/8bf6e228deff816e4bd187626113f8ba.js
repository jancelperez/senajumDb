...
test('obtener imagen', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-db/test/db-test.js', 69), _avaThrowsHelperEnd(t, db.getImagen('equivoca'))), /no encotrada/);
  });
...
test('obtener usuario', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-db/test/db-test.js', 110), _avaThrowsHelperEnd(t, db.getUsuario('foo'))), /not found/);
  });
...
//# sourceMappingURL=..\node_modules\.cache\ava\8bf6e228deff816e4bd187626113f8ba.js.map